...
function createProductBase({
	...
	description = '상품설명',
	price = '가격',
	image = {thumbnail: '', view: '', banner: '', info: '', alt: ''},
	// saleRatio =  0.25,
	// salePrice = 3375,
}) {
	const template = /* html */ `
				...
				<!-- 왼쪽 이미지 -->
				<img class="thumbnailImg" alt="상품 이미지" src="/assets/images/product/${image.thumbnail}" />
				<!-- 오른쪽 정보 -->

				<div class="w-[560px]">
					<!-- 제목 -->
					<div class="flexFlexCol gap-[16px] pb-[20px]">
						<div class="flexFlexCol gap-[4px]">
					...
					<div>
						...
						<dl class="border-t-[1px] poductSimpleDiv">
							<dt class="poductSimpleTitle">배송</dt>
							<dd class="poductSimpleInfo">
								<p>샛별배송</p>
								<p class="text-gray/400">23시 전 주문 시 내일 아침 7시 전 도착 <br />(대구 부산 울산 샛별배송 운영시간 별도 확인)</p>
							</dd>
						</dl>
						<dl class="poductSimpleDiv">
							<dt class="poductSimpleTitle">판매자</dt>
							<dd class="gro poductSimpleInfo">컬리</dd>
						</dl>
						<dl class="poductSimpleDiv">
							<dt class="poductSimpleTitle">포장타입</dt>
							<dd class="poductSimpleInfo">
								<p>상온 (종이포장)</p>
						...
						<dl class="poductSimpleDiv">
							<dt class="poductSimpleTitle">판매단위</dt>
							<dd class="poductSimpleInfo">1봉</dd>
						</dl>
						<dl class="poductSimpleDiv">
							<dt class="poductSimpleTitle">중량/용량</dt>
							<dd class="poductSimpleInfo">123g*4봉</dd>
						</dl>
						<dl class="poductSimpleDiv">
							<dt class="poductSimpleTitle">원산지</dt>
							<dd class="poductSimpleInfo">상세페이지 별도표기</dd>
						</dl>

						<dl class="poductSimpleDiv">
							<dt class="poductSimpleTitle">알레르기정보</dt>
							<dd class=" poductSimpleInfo">
								<p>-대두, 밀, 쇠고기 함유</p>
						...
						<dl class="poductSimpleDiv">
							<dt class="poductSimpleTitle">상품선택</dt>
							<dd class="grow">
								<div class="pxl-[12px] relative flexFlexCol gap-[16px] border-[1px] border-solid border-gray/100 py-[12px] pl-[16px] pr-[12px]">
									<p class="poductSimpleInfo">${name} (4개입)</p>
						...
						<div class="py-[28px] text-right">
							<p class="font-semibold">총 상품금액<span class="pl-[17px] text-xl text-content">${price.toLocaleString()}</span>원</p>
...
function createProductDetail({
  ...
  <!-- 베너 이미지 -->
	...
	<!-- 간단설명 -->
	<div class="flexFlexCol items-center">
...
function createProductReview({
	...
	<div class="border-t-[1px]">
		...
		<div class="flex gap-[82px] border-b-[1px] border-gray/100 p-[20px]">
			<div class="flexFlexrow h-[18px] flex-wrap gap-[8px]">
			...
			<div class="flexFlexCol gap-[20px]">
...
function createProductQna(
	...
	<div>
		<div class="flexFlexrow h-[58px] items-center justify-between border-b-[1px] border-t-[2px] font-semibold">
		...
		<div class="flexFlexrow h-[58px] items-center justify-between border-b-[1px] border-t-[2px] text-sm">
			<p class="grow font-semibold"><span class="mr-[20px] rounded-xs bg-gray/100 px-[8px] font-semibold ">공지</span>판매(일시)중단 제품 안내 (22.11.10 업데이트)</p>
		...
		<div class="flexFlexrow h-[58px] items-center justify-between border-b-[1px] border-t-[2px] text-sm">
			<p class="grow font-semibold"><span class="mr-[20px] rounded-xs bg-gray/100 px-[8px] ">비밀글입니다.</p>
			<p class="w-[100px] text-center">김**사</p>
			<time class="w-[100px] text-center" datetime="2022-11-10T20:00:00">2022.11.10</time>
			<p class="w-[100px] text-center">답변대기</p>
		</div>
		<div class="flexFlexrow h-[58px] items-center justify-between border-b-[1px] border-t-[2px] text-sm ">
			<p class="grow font-semibold"><span class="mr-[20px] rounded-xs bg-gray/100 px-[8px] ">비밀글입니다.</p>
			<p class="w-[100px] text-center">심*범</p>
			<time class="w-[100px] text-center" datetime="2022-11-10T20:00:00">2022.11.10</time>
			<p class="w-[100px] text-center">답변완료</p>
		</div>
	</div>
